...
/**
 * ViewComEnquiries class implements the IViewData interface for handling camp data.
 * This class provides methods to view Commitee enquiries.
 */
public class ViewComEnquiries implements IViewData {

	/**
	 * This method reads list of enquiries for committee member's viewing, and writes
	 * committee member's response
	 * @param user user
	...
	public void Data(User user, CampList campList) {
		...
		for(int i=0; i<enquiryList.size(); i++) {
			...
			if (enquiryList.get(i).getName().equalsIgnoreCase(campName) && (enquiryList.get(i).getEnquiryOrReply() == 0)) {
				enquiryFound = true;
				System.out.println("====================================================================================");
