 ...
 * This class provides methods to view student Camp.
 */
public class ViewCampStudent implements IViewData {
	...
	public void Data(User user, CampList campList) {
		...
		for(int i=0; i<campList.size(); i++) {
			...
			if(campList.get(i).getUserGroup().equals(student.getFaculty()) || campList.get(i).getUserGroup().equals("ALL")) {
			...
			else if(campList.get(i).getUserGroup()==null){
