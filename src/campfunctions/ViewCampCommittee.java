 ...
 * This class provides methods to view Commitee Camp.
 */
public class ViewCampCommittee implements IViewData {
	...
	public void Data(User user, CampList campList) {
		...
		for(int i=0; i<campList.size(); i++) {
			...
			if(campList.get(i).getCommitteeIdList().contains(user.getUserID())){
